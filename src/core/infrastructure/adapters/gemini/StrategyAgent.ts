...
export class GeminiStrategyAgent extends BaseGeminiAgent {
  ...
  protected buildPrompt(context: Record<string, unknown>): string {
    return [
      ...
      "",
      "--- SEQUENCE TYPES ---",
      "COLD_ICP: 5-touch over 18 days. High-ICP, cold lead.",
      "COLD_LOW_ICP: 3-touch over 10 days.",
      "INBOUND_WARM: 3-touch over 7 days. Fast cadence.",
      "RE_ENGAGE: 4-touch over 21 days. Dormant leads.",
      "CHAMPION: 2-touch. Referrals or past customers.",
      "",
      "--- SELECTION LOGIC ---",
      "score >= 70 + inbound signal -> INBOUND_WARM",
      "score >= 70, cold -> COLD_ICP",
      "score 50–69, cold -> COLD_LOW_ICP",
      "last contact > 90 days -> RE_ENGAGE",
      "referred/champion signal -> CHAMPION",
      "",
      "--- CONTEXT ---",
