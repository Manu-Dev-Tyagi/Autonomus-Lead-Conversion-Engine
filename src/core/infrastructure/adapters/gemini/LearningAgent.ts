...
export class GeminiLearningAgent extends BaseGeminiAgent {
  ...
  protected buildPrompt(context: Record<string, unknown>): string {
    return [
      ...
      "- Industry vertical, Company size bucket, Seniority level.",
      "- Sequence type, Day/Hour of send, Touch number.",
      "- Personalization tier used.",
      "",
      "--- SUGGESTION CATEGORIES ---",
      "LOW RISK (Auto-update): Adjust send times, re-rank templates, RAG window adjustment.",
      "HIGH RISK (Human review): Change qualification thresholds, sequence steps, ICP criteria.",
      "",
      "--- CORE PRINCIPLES ---",
      "1. STATISTICAL SIGNIFICANCE: p < 0.05 before recommending action.",
      "2. EFFECT SIZE: Minimum 5% difference vs baseline.",
      "3. REASONING: Detailed data-driven justification.",
      "",
      "--- CONTEXT ---",
